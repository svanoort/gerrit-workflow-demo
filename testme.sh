...
sudo docker run  -i -t --rm=true -v `pwd`/jenkins/jenkins_home:/var/jenkins_home -p 8081:8080 --name jenkins --link gerrit:gerrit jenkins-gerrit-wfdemo-jenkins:1.0 /bin/bash
